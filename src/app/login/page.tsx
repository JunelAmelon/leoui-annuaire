      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-10 lg:px-16 xl:px-20 py-12 bg-white overflow-y-auto">
        ...
        <div className="max-w-[22rem] w-full mx-auto">
          ...
          <div className="grid grid-cols-2 gap-3 mb-10">
            <button className="flex items-center justify-center gap-2 px-4 py-2.5 border border-charcoal-200 hover:bg-charcoal-50 transition-colors text-xs font-medium text-charcoal-700 tracking-wide">
            ...
            <button className="flex items-center justify-center gap-2 px-4 py-2.5 border border-charcoal-200 hover:bg-charcoal-50 transition-colors text-xs font-medium text-charcoal-700 tracking-wide">
              <svg fill="#1877F2" viewBox="0 0 24 24" style={{ width: '16px', height: '16px', flexShrink: 0 }}>
