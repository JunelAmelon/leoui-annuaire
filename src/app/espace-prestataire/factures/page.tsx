...
import { Receipt, Plus, Search, Download, Eye, CheckCircle, Clock, AlertCircle, X, Trash2, Edit, Send, Sparkles, Loader2 } from 'lucide-react';
...
export default function FacturesPage() {
  ...
  return (
    <PrestataireDashboardLayout>
      <div className="max-w-4xl mx-auto space-y-6 relative min-h-[72vh]">
        <div className={featureLocked ? 'pointer-events-none opacity-45 saturate-0 select-none space-y-6' : 'space-y-6'}>
        ...
        {featureLocked && (
          <div className="absolute inset-0 z-40 flex items-center justify-center">
            <div className="absolute inset-0 bg-charcoal-950/25 backdrop-blur-[1.5px] rounded-2xl" />
            <div className="relative max-w-md text-center rounded-2xl border border-white/60 bg-white/90 shadow-xl px-6 py-5">
              ...
              <p className="text-sm text-charcoal-600 mt-2 leading-relaxed">
                Cette fonctionnalite est en cours de finalisation et sera disponible tres prochainement.
              </p>
              <p className="mt-3 inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium text-charcoal-600 bg-stone-100 border border-stone-200">
                <Loader2 className="w-3.5 h-3.5 animate-spin" /> En cours de preparation
              </p>
            </div>
          </div>
        )}
