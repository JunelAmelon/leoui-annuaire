    ...
    <div className="space-y-6">
        ...
        >
          ...
          >
            <div className="relative h-32 flex-shrink-0">
              <img src="/mariage (5).jpg" alt="Rendez-vous" className="w-full h-full object-cover" />
      ...
      {showAdd && (
        ...
        >
          ...
          >
            <div className="relative h-32 flex-shrink-0">
              <img src="/mariage (1).jpg" alt="Rendez-vous" className="w-full h-full object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
              <div className="w-full pt-3 sm:hidden flex justify-center absolute top-0">
                <div className="w-12 h-1.5 bg-white/70 rounded-full" />
              </div>
              ...
              <div className="absolute bottom-3 left-4 sm:left-6 right-4">
                <h3 className="font-display text-lg font-semibold text-white">{editingId ? 'Modifier le rendez-vous' : 'Nouveau rendez-vous'}</h3>
              </div>
            </div>
